from flask import Flask, url_for, make_response, request, session, redirect, render_template, abort
import datetime
...
def session_reset():
    ...
    return make_response('Вы сбросили сессию')
...
def add_news():
    ...
    if form.validate_on_submit():
        ...
        db_sess.commit()
        return redirect('/')
    return render_template('news.html', title='Добавление новостей',
                           form=form)
